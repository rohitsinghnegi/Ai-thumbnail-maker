...
const PromptInput = () => {
  const { prompt, setPrompt, setCurrentStep, resetFlow, enhancePrompt, setEnhancePrompt, startGeneration } = useUIStore();
          ...
          <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-blue-900">AI Prompt Enhancement</h4>
                  <p className="text-xs text-blue-700 mt-0.5">Let our AI improve your prompt for better results</p>
                </div>
              </div>
